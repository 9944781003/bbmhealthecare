...
if(isset($_POST["name"],$_POST["email"],$_POST["phone"])){
		...
		$MESSAGE_BODY .= "</body></html>";
		 if($robotest)
			...
			<p style='font-family:verdana;font-size:12px;'>
			<a href='Location:http://bbmhealthcare.com/downloads/BBM_Health_Broucher.pdf'> Download</a>
			</p>
			</center>
			</body>
			</html>";	
			}
			 header("Location:http://bbmhealthcare.com/downloads/BBM_Health_Broucher.pdf");
} else{
